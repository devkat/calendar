System.register(["aurelia-dependency-injection", "../../services/google-service", "../../services/calendar-service"], function(exports_1, context_1) {
    "use strict";
    ...
    var aurelia_dependency_injection_1, google_service_1, calendar_service_1;
    var Calendars;
    return {
        setters:[
        ...
        execute: function() {
            let Calendars = class Calendars {
                constructor(googleService, calendarService) {
            ...
            Calendars = __decorate([
                ...
                __metadata('design:paramtypes', [google_service_1.GoogleService, calendar_service_1.CalendarService])
            ], Calendars);
